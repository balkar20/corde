...
public class TrafficFlowWorker
{
    ...
    private readonly Processor<Track> _processorPool;
    ...
    public TrafficFlowWorker(ITrackDevice trackDevice, Processor<Track> processorPool, ITrackProducer trackProducer, ITrackConsumer trackConsumer)
    {
    ...
    async Task ConsumeOneTrackAsync(Track track)
    {
        ...
        await _processorPool.ProcessAsync(track);
        Treads.Add(Thread.CurrentThread.ManagedThreadId);
