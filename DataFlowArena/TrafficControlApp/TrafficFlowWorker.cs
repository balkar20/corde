...
public class TrafficFlowWorker
{
    ...
    private readonly IProcessor<Track> _processorPool;
    ...
    public TrafficFlowWorker(ITrackDevice trackDevice, IProcessor<Track> processorPool, ITrackProducer trackProducer, ITrackConsumer trackConsumer)
    {
